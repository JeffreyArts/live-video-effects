...
export class OptionsService {
    private static readonly STORAGE_KEY = 'webcam-options';
    ...
    private loadOptions(): Options {
        ...
        try {
            const stored = localStorage.getItem(OptionsService.STORAGE_KEY);
            if (stored) {
    ...
    private saveOptions(): void {
        try {
            localStorage.setItem(OptionsService.STORAGE_KEY, JSON.stringify(this.options));
        } catch (error) {
    ...
    public setShowVideo(value: boolean): void {
        this.options.showVideo = value;
        this.saveOptions();
    }

    public setGridSize(x: number, y: number): void {
        this.options.gridSize = { x, y };
        this.saveOptions();
    }

    public setBufferSize(value: number): void {
        this.options.bufferSize = value;
        this.saveOptions();
    }

    public setSignificantChangeThreshold(value: number): void {
        this.options.significantChangeThreshold = value;
        this.saveOptions();
    }

    public setSelectedStyle(value: string): void {
        this.options.selectedStyle = value;
        this.saveOptions();
    }
} 
...
const styles: Style[] = [
    ...
    },
    {
        ...
        valueRange: 2,
        values: [
            { min: 0, max: 0, val: "c1/vert.png" },
            { min: 1, max: 1, val: "c1/hor.png" },
            { if: "t==1 && tl==1 && tr==1 && bl==1 && br==1&& c==0",  val: "c1/empty.png" },
            { if: "b==1 && bl==1 && br==1 && tl==1 && tr==1&& c==0",  val: "c1/empty.png" },
            { if: "l==1 && tl==1 && bl==1 && tr==1 && br==1&& c==0",  val: "c1/empty.png" },
            { if: "r==1 && tr==1 && br==1 && tl==1 && bl==1&& c==0",  val: "c1/empty.png" },
            { if: "r==1 && c==1 && l==0",  val: "c1/hor-r.png" },
            { if: "l==1 && c==1 && r==0",  val: "c1/hor-l.png" },
            { if: "b==1 && br==1 && bl==1 && c==0",  val: "c1/vert-t.png" },
            { if: "t==1 && tl==1 && tr==1 && c==0",  val: "c1/vert-b.png" },

            { if: "t==0 && l==0 && c==1",  val: "c1/hoek-tr.png" },
            { if: "t==0 && r==0 && c==1",  val: "c1/hoek-tl.png" },
            { if: "b==0 && r==0 && c==1",  val: "c1/hoek-bl.png" },
            { if: "b==0 && l==0 && c==1",  val: "c1/hoek-br.png" },
        ]
    },
    {
        name: "Zwarte blokken",
